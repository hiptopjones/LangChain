...
public static class OpenRouterModelProvider
{
    private static Dictionary<OpenRouterModelIds, ChatModels> Models { get; set; } = new()
    {
        ...
        { OpenRouterModelIds.MetaLlama38B, new ChatModels("meta-llama/llama-3-8b",8192,0.00017999999999999998,0.00017999999999999998)},
        { OpenRouterModelIds.MetaLlama370B, new ChatModels("meta-llama/llama-3-70b",8192,0.0008100000000000001,0.0008100000000000001)},
        { OpenRouterModelIds.MetaLlamaguard28B, new ChatModels("meta-llama/llama-guard-2-8b",8192,0.00017999999999999998,0.00017999999999999998)},
