...
public static class OpenRouterModelProvider
{
    private static Dictionary<OpenRouterModelIds, ChatModels> Models { get; set; } = new()
    {
        ...
        { OpenRouterModelIds.Noromaid20B, new ChatModels("neversleep/noromaid-20b",8192,0.0015,0.00225)},
        ...
        { OpenRouterModelIds.Fimbulvetr11BV2, new ChatModels("sao10k/fimbulvetr-11b-v2",8192,0.000375,0.0015)},
        { OpenRouterModelIds.Llama3Lumimaid8B, new ChatModels("neversleep/llama-3-lumimaid-8b",24576,0.0002006,0.001125)},
        { OpenRouterModelIds.Llama3Lumimaid70B, new ChatModels("neversleep/llama-3-lumimaid-70b",8192,0.003375,0.0045)},
        ...
        { OpenRouterModelIds.MetaLlama38BInstructExtended, new ChatModels("meta-llama/llama-3-8b-instruct:extended",16384,0.0002006,0.001125)},
        { OpenRouterModelIds.Llama3Lumimaid8BExtended, new ChatModels("neversleep/llama-3-lumimaid-8b:extended",24576,0.0002006,0.001125)},
        { OpenRouterModelIds.MancerWeaverAlpha, new ChatModels("mancer/weaver",8000,0.001875,0.00225)},
        ...
        { OpenRouterModelIds.MetaLlama38BBase, new ChatModels("meta-llama/llama-3-8b",8192,0.00017999999999999998,0.00017999999999999998)},
        { OpenRouterModelIds.MetaLlama370BBase, new ChatModels("meta-llama/llama-3-70b",8192,0.0008100000000000001,0.0008100000000000001)},
        { OpenRouterModelIds.DatabricksDbrx132BInstruct, new ChatModels("databricks/dbrx-instruct",32768,0.00108,0.00108)},
        ...
        { OpenRouterModelIds.OpenAiGpt4O, new ChatModels("openai/gpt-4o",128000,0.005,0.015)},
        { OpenRouterModelIds.OpenAiGpt4O20240513, new ChatModels("openai/gpt-4o-2024-05-13",128000,0.005,0.015)},
        ...
        { OpenRouterModelIds.GoogleGeminiFlash15Preview, new ChatModels("google/gemini-flash-1.5",2800000,0.00025,0.00075)},
        { OpenRouterModelIds.PerplexityLlama3Sonar8B, new ChatModels("perplexity/llama-3-sonar-small-32k-chat",32768,0.0002,0.0002)},
        { OpenRouterModelIds.PerplexityLlama3Sonar8BOnline, new ChatModels("perplexity/llama-3-sonar-small-32k-online",28000,0.0002,0.0002)},
        { OpenRouterModelIds.PerplexityLlama3Sonar70B, new ChatModels("perplexity/llama-3-sonar-large-32k-chat",32768,0.001,0.001)},
        { OpenRouterModelIds.PerplexityLlama3Sonar70BOnline, new ChatModels("perplexity/llama-3-sonar-large-32k-online",28000,0.001,0.001)},
        ...
        { OpenRouterModelIds.NousHermes13B, new ChatModels("nousresearch/nous-hermes-llama2-13b",4096,0.00017999999999999998,0.00017999999999999998)},
        ...
        { OpenRouterModelIds.MetaLlamaguard28B, new ChatModels("meta-llama/llama-guard-2-8b",8192,0.0002,0.0002)},
        ...
        { OpenRouterModelIds.Phi3MiniInstruct, new ChatModels("microsoft/phi-3-mini-128k-instruct",128000,0.0001,0.0001)},
        { OpenRouterModelIds.Phi3MediumInstruct, new ChatModels("microsoft/phi-3-medium-128k-instruct",128000,0.001,0.001)},
        ...
        { OpenRouterModelIds.MistralMistral7BInstructV01, new ChatModels("mistralai/mistral-7b-instruct-v0.1",8000,0.0002,0.0002)},
        { OpenRouterModelIds.MistralMistral7BInstructV02, new ChatModels("mistralai/mistral-7b-instruct-v0.2",32768,7.000000000000001E-05,7.000000000000001E-05)},
        { OpenRouterModelIds.MistralMistral7BInstruct, new ChatModels("mistralai/mistral-7b-instruct",32768,7.000000000000001E-05,7.000000000000001E-05)},
        { OpenRouterModelIds.MistralMistral7BInstructV03, new ChatModels("mistralai/mistral-7b-instruct-v0.3",32768,7.000000000000001E-05,7.000000000000001E-05)},
        ...
        { OpenRouterModelIds.NousresearchHermes2ProLlama38B, new ChatModels("nousresearch/hermes-2-pro-llama-3-8b",8192,0.00015,0.00015)},
        { OpenRouterModelIds.Qwen1572BChat, new ChatModels("qwen/qwen-72b-chat",32768,0.0009,0.0009)},
        { OpenRouterModelIds.Qwen1532BChat, new ChatModels("qwen/qwen-32b-chat",32768,0.00075,0.00075)},
        { OpenRouterModelIds.DeepseekV2Chat, new ChatModels("deepseek/deepseek-chat",128000,0.00014000000000000001,0.00028000000000000003)},
        { OpenRouterModelIds.DeepseekCoder, new ChatModels("deepseek/deepseek-coder",16000,0.00014000000000000001,0.00028000000000000003)},
        { OpenRouterModelIds.MetaLlamaV270BChatNitro, new ChatModels("meta-llama/llama-2-70b-chat:nitro",4096,0.0009,0.0009)},
        { OpenRouterModelIds.Mythomax13BNitro, new ChatModels("gryphe/mythomax-l2-13b:nitro",4096,0.0002,0.0002)},
        { OpenRouterModelIds.MistralMistral7BInstructNitro, new ChatModels("mistralai/mistral-7b-instruct:nitro",32768,7.000000000000001E-05,7.000000000000001E-05)},
