...
public static class OpenRouterModelProvider
{
    private static Dictionary<OpenRouterModelIds, ChatModels> Models { get; set; } = new()
    {
        ...
        { OpenRouterModelIds.MetaLlamaV213BChat, new ChatModels("meta-llama/llama-2-13b-chat",4096,1.206E-07,1.206E-07)},
        ...
        { OpenRouterModelIds.NousHermes2Mixtral8X7BSft, new ChatModels("nousresearch/nous-hermes-2-mixtral-8x7b-sft",32000,5.4E-07,5.4E-07)},
        ...
        { OpenRouterModelIds.ChronosHermes13BV2, new ChatModels("austism/chronos-hermes-13b",4096,1.8000000000000002E-07,1.8000000000000002E-07)},
        ...
        { OpenRouterModelIds.Zephyr141BA35b, new ChatModels("huggingfaceh4/zephyr-orpo-141b-a35b",65536,6.499999999999999E-07,6.499999999999999E-07)},
        ...
        { OpenRouterModelIds.Wizardlm27B, new ChatModels("microsoft/wizardlm-2-7b",32000,1.0000000000000001E-07,1.0000000000000001E-07)},
